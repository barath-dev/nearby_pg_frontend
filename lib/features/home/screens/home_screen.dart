                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          // TODO: Navigate to featured PGs
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Featured PGs page coming soon!'),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
                        },
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    // TODO: Navigate to all nearby PGs
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Nearby PGs page coming soon!'),
                        behavior: SnackBarBehavior.floating,
                      ),
                    );
                  },
